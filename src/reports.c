...
// Exibe relatorio com todas as aeronaves cadastradas
void report_fleet(db_aircraft_t *db_aircraft) {
  ...
  // Percorre a lista exibindo os detalhes de cada aeronave
...
// Exibe relatorio com todas as rotas cadastradas
void report_routes(db_routes_t *db_routes) {
  ...
  // Percorre a lista exibindo os detalhes de cada rota
  while (current_route) {
    printf("ID da rota....................: %d\n", current_route->id);
