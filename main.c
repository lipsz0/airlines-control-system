...
int main(void) {
  ...
  // Estruturas principais que armazenam as listas de aeronaves e rotas
  ...
  // Carrega os dados dos arquivos binarios para a memoria
  ...
  do {
    ...
    case 0:
      // Salva os dados em disco antes de encerrar
      clear_terminal();
